...
@section('content')
	<div class="container mx-auto px-4 py-8">
		...
		<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
			<h1 class="text-xl sm:text-2xl font-semibold">Session Details for {{ $course->name }}</h1>
		...
		<div class="bg-white shadow rounded-lg overflow-hidden">
			<div class="px-4 py-5 border-b border-gray-200">
				...
				<p class="mt-1 text-sm text-gray-500">Details about the course session</p>
			</div>
			<div class="divide-y divide-gray-200">
				<div class="px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4">
					<span class="text-sm font-medium text-gray-500">Course Name</span>
				...
				<div class="px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4">
					<span class="text-sm font-medium text-gray-500">Session Date</span>
				...
				<div class="px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4">
					...
					<span class="mt-1 sm:col-span-2">
						@if ($session->is_active)
							<span
								class="px-2 py-1 inline-flex text-xs font-semibold rounded-full bg-green-100 text-green-800">Active</span>
						@else
							<span
								class="px-2 py-1 inline-flex text-xs font-semibold rounded-full bg-red-100 text-red-800">Inactive</span>
						@endif
					</span>
				</div>
			</div>
		...
		{{-- Attendance Records --}}
		<div class="mt-8">
			<h2 class="text-lg sm:text-xl font-semibold mb-4">Attendance Records</h2>
					...
					<table class="min-w-full text-sm bg-white shadow rounded-lg">
						<thead class="bg-gray-100">
							<tr>
								...
								<th class="py-3 px-4 text-left font-medium text-gray-700">Attendance Time</th>
